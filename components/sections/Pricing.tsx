      ...
      <div className="mx-auto max-w-7xl px-6 text-center">
        <BlurFade inView inViewMargin="-100px">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted">
            We scope each engagement based on what you need and what will
            deliver the most value. Book a call to discuss your situation.
          </p>
        </BlurFade>
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-3">
          {MODELS.map((model, i) => {
            ...
            return (
              <BlurFade key={model.title} inView delay={i * 0.15} inViewMargin="-50px">
                <div className="relative rounded-2xl border border-gray-100 bg-white p-8 shadow-sm transition-shadow hover:shadow-md overflow-hidden">
                  <BorderBeam
                    colorFrom="#2563EB"
                    colorTo="#60a5fa"
                    duration={10}
